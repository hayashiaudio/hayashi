...
const PARAMETRIC_EQ_ARCHITECTURES: OptimizationArchitectureDefinition[] = [
  ...
  },
  {
    ...
    parameterRanges: [
      { id: 'band1_gain_db', min: -15, max: 15, initial: 0 },
      { id: 'band2_gain_db', min: -15, max: 15, initial: 0 },
      { id: 'band3_gain_db', min: -15, max: 15, initial: 0 },
      { id: 'band4_gain_db', min: -15, max: 15, initial: 0 },
      { id: 'band5_gain_db', min: -15, max: 15, initial: 0 },
      { id: 'global_q_bias', min: 0.4, max: 4.0, initial: 1.0 },
      { id: 'trim_db', min: -6, max: 6, initial: 0 },
    ],
    defaultMetricWeights: {
